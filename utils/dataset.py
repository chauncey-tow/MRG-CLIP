...
class MixSingleImageDataset(Dataset):
    def __init__(self, args, tokenizer, split, transform=None):
        self.image_dir = {'iu_xray': '/home/ai1010/dc/data/iu_xray/iu_data/iu_xray/images',
                          'mimic_cxr': '/home/ai1010/dc/data/iu_xray/mimic_cxr/images'}
        self.ann_path = {'iu_xray': "/home/ai1010/dc/data/iu_xray/iu_data/iu_xray/annotation.json",
                         'mimic_cxr': "/home/ai1010/dc/data/iu_xray/mimic_cxr/annotation.json"}
        self.max_seq_length = args["max_seq_length"]
        self.split = split
